...
Watch a [video](https://drive.google.com/file/d/15qRHrsYWXeT-E3BgON454462CmDrAj9-/view) demonstration of the basic functionality:
...
## Tests
Each shape class (Circle, Square, and Triangle) is tested for a render() method that returns a string for the corresponfing SVG file matching color and text requests. Type "npm run test" in the command line and Jest will run all three tests.